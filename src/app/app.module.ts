...
const appRoutes: Routes = [
  ...
  { path: 'profile/fundraiser/:id', canActivate: [AuthGuardService, SitterProfileGuardService], component: SitteridComponent },
  { path: 'profile/investor/:id', canActivate: [AuthGuardService, ParentProfileGuardService], component: ParentIdComponent },
  { path: 'auth/signIn', canActivate: [ReverseAuthGuardService], component: SigninComponent },
  { path: 'viewprofile/fundraiser/:id', component: SitterComponent },
  { path: 'viewprofile/investor/:id', component: ParentComponent },
  { path: 'auth/inventor/signUp', canActivate: [ReverseAuthGuardService], component: SignUpAComponent  },
  { path: 'auth/fundraiser/signUp', canActivate: [ReverseAuthGuardService], component: SignUpBComponent  },
